...
resource "aws_vpc" "this" {
  ...
  tags = "${merge(map("Name", format("vpc_%s", var.name)), var.vpc_tags, var.tags)}"
}
...
resource "aws_internet_gateway" "this" {
  ...
  tags = "${merge(map("Name", format("igw_%s", var.name)), var.igw_tags, var.tags)}"
}
...
resource "aws_route_table" "public" {
  ...
  tags = "${merge(map("Name", format("rt_%s_public", var.name)), var.public_route_table_tags, var.tags)}"
}
...
resource "aws_route_table" "private" {
  ...
  tags = "${merge(map("Name", (var.single_nat_gateway ? "nat_${var.name}-private" : format("rt_%s_private_%s", var.name, element(var.azs, count.index)))), var.private_route_table_tags, var.tags)}"
...
resource "aws_route_table" "intra" {
  ...
  tags = "${merge(map("Name", "rt_${var.name}-intra"), var.intra_route_table_tags, var.tags)}"
}
...
resource "aws_subnet" "public" {
  ...
  tags = "${merge(map("Name", format("subnet_%s_public_%s", var.name, element(var.azs, count.index))), var.public_subnet_tags, var.tags)}"
}
...
resource "aws_subnet" "private" {
  ...
  tags = "${merge(map("Name", format("subnet_%s_private_%s", var.name, element(var.azs, count.index))), var.private_subnet_tags, var.tags)}"
}
...
resource "aws_subnet" "database" {
  ...
  tags = "${merge(map("Name", format("subnet_%s_db_%s", var.name, element(var.azs, count.index))), var.database_subnet_tags, var.tags)}"
}
...
resource "aws_subnet" "redshift" {
  ...
  tags = "${merge(map("Name", format("%s_redshift_%s", var.name, element(var.azs, count.index))), var.redshift_subnet_tags, var.tags)}"
}
...
resource "aws_subnet" "elasticache" {
  ...
  tags = "${merge(map("Name", format("%s_elasticache_%s", var.name, element(var.azs, count.index))), var.elasticache_subnet_tags, var.tags)}"
}
...
resource "aws_subnet" "intra" {
  ...
  tags = "${merge(map("Name", format("subnet_%s_intra_%s", var.name, element(var.azs, count.index))), var.intra_subnet_tags, var.tags)}"
}
...
resource "aws_eip" "nat" {
  ...
  tags = "${merge(map("Name", format("nat_%s_%s", var.name, element(var.azs, (var.single_nat_gateway ? 0 : count.index)))), var.nat_eip_tags, var.tags)}"
}
...
resource "aws_nat_gateway" "this" {
  ...
  tags = "${merge(map("Name", format("nat_%s_%s", var.name, element(var.azs, (var.single_nat_gateway ? 0 : count.index)))), var.nat_gateway_tags, var.tags)}"
